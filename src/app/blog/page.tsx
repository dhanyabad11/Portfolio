        ...
        <div className="max-w-6xl">
            <div className="flex justify-between items-start mb-12">
                ...
                <div className="text-right space-y-3">
                    <Link href="#" className="block text-red-600 hover:text-red-800 text-lg">
                        E-mail update
                    </Link>
                    <Link href="/rss.xml" className="block text-red-600 hover:text-red-800 text-lg">
                        RSS feed
                    </Link>
                </div>
            </div>
            ...
            <p className="text-xl mb-12">
                ...
                <Link href="https://zerodha.tech" className="text-red-600 hover:text-red-800">
                    zerodha.tech blog
                </Link>
                .
            </p>
